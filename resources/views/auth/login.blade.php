...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta content="Divine Tech professionals" name="Divine Tech" />
        <meta content="Themesbrand" name="RaymondNathaniel" />
        <!-- App favicon -->
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Cooperative</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="form-floating form-floating-custom mb-4">
                                                <input id="email" type="email" placeholder="Enter User Name" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                                @error('email')
                                            ...
                                            <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                                                <input id="password" type="password" placeholder="Enter Password"  class="form-control pe-5 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                                @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>

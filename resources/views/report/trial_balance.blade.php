            ...
            <form  onsubmit="signUp(event)" method="post" id="frm_main">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="gl_name" class="form-control form-select" data-trigger id="choices-single-default" required>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#filter').on('click', async function(e) {
            ...
            try {
                const getApplications = await request("{{ route('searchAndFilterTrialBalanceByGlcode') }}?id=" +    id +"&end_date=" + end_date +"&start_date=" + start_date);
                loader.hide();

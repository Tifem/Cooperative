                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Monthly Deduction Summary</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="/home">{{Auth::user()->name}}</a></li>
                                    <li class="breadcrumb-item active">Monthly Deduction Summary</li>
                                </ol>
                            </div>
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody class="deduction_details">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right">{{ number_format($deduction->savingDeduction(), 2) }}</td>
                                            <td style="text-align: right">{{ number_format($deduction->loanDeduction(), 2) }}</td>
                                            <td style="text-align: right">{{ number_format($deduction->totalMonthlyDeduction(), 2) }}</td>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#filter').on('click', async function(e) {
                ...
                loader.show();
                window.location.href = "filter-monthly-deduction-summary-by-month?id=" +  id 
            }
            });

                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Loan Deduction Pivot</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="/home">{{Auth::user()->name}}</a></li>
                                    <li class="breadcrumb-item active">Loan Deduction</li>
                                </ol>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                {{-- <form action="{{route('filter_pivot_table')}}" > --}}
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <button type="submit" onClick="this.disabled=true" class="btn btn-primary form-control mt-2" id="filter"><i class="bx bx-loader bx-spin font-size-16 align-middle me-2" style="display: none;" id="loader"></i>Search</button></button>
                                    </div>
                                {{-- </form> --}}
                            </div>
                            <hr>
